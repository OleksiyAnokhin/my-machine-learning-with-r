...
```{r, message = FALSE, warning = FALSE}
# misClassError(test_data$Survived, predicted, threshold = optCutOff)
```
...
```{r, message = FALSE, warning = FALSE}
plotROC(test_data$Survived, predicted)
```
...
```{r, message = FALSE, warning = FALSE}
Concordance(test_data$Survived, predicted)
```
...
```{r, message = FALSE, warning = FALSE}
sensitivity(test_data$Survived, predicted, threshold = optCutOff)
specificity(test_data$Survived, predicted, threshold = optCutOff)
```

**Confusion Matrix**

```{r, message = FALSE, warning = FALSE}
confusionMatrix(test_data$Survived, predicted, threshold = optCutOff)
```
